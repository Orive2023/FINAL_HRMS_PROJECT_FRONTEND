...
const Officeshift = () => {
    ...
    const loadAward = async () => {
        const response = await axios.get("https://api.orivehrms.com/officeshifts/get/officeShifts");
  ...
  const convertToPdf = () => {
    try {
      ...
      doc.autoTable({
        head: [["SL", "CREATED DATE", "OFFICECLOCK IN", "OFFICECLOCK OUT"]],
          ...
          >
            ...
            >
              ...
              <div style={{ padding: "2px" }}>
                ...
                <span style={{ color: "black" }}> Office Shift</span>
              </div>
            </div>
          </div>
                {
