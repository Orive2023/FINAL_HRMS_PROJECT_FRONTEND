...
const JoiningExpTable = ({
  ...
  return (
    ...
    <SideBar menu={menu} setMenu={setMenu}/>
      ...
      <div
            className="mx-3"
            style={{ marginTop: "70px", marginBottom: "-70px", width: "150px" }}
          >
            <div
              style={{
                fontSize: "1.4rem",
            ...
            >
              ...
              <div style={{ padding: "2px" }}>
                ...
                <span style={{ color: "black" }}> Experience Joining Letter</span>
              </div>
            </div>
          </div>
      <div
              ...
              : (rowsPerPage > 0
                    ...
                    if (search.length === 0) return elem;
                      ...
                      return (
                        ...
                        elem.employeeDesignation
                          ...
                          .toLowerCase()
                          .includes(search.toLocaleLowerCase()) ||
                        elem.salaryComponentPerMonth
                          .toLowerCase()
                          .includes(search.toLocaleLowerCase()) ||
                        elem.salaryComponentPerBasic
                          .toLowerCase()
                          .includes(search.toLocaleLowerCase()) ||
                          elem.grossSalary
                          .toLowerCase()
                  ...
                  .map((item, index) => (
                    <tr key={index}>
                      ...
                      <td>{item.salaryComponentPerMonth}</td>
                      <td>{item.salaryComponentPerBasic}</td>
                      <td>{item.grossSalary}</td>
                      <td>{item.pancardNo}</td>
                      <td>{item.aaddharcardNo}</td>
                    </tr>
                  ))}
          </tbody>
          <tfoot>
