          ...
          <Collapse className="mt-3" in={formVisible}>
            ...
            >
              <div style={{ marginTop: "20px" }}>
                ...
                >
                  <h3> ACCOUNT BALANCE FORM</h3>
                </h3>
                <DialogContent>
                  <AccountBalanceForm formData={formData} setFormData={setFormData} setFormVisible={setFormVisible} setToggle={setToggle}/>
                </DialogContent>
              </div>
            </Card>
          </Collapse>
          <AccountBalanceTable accountBalance={accountBalance} setRecDelete={setRecDelete} setFormVisible={setFormVisible} toggle={toggle} setToggle={setToggle}/>
        </section>
      </div>
    </div>
  </div>
