        ...
        <section>
         ...
         <div style={{padding:'2px'}}>
          ...
          <Link to="/HRDashboard" style={{ textDecoration: 'none', color: 'inherit' }}>
           Dashboard </Link> / 
           Account /</span> 
            <span style={{color:'black'}}> debit</span>
          </div>
          </div>
          ...
          <Collapse className="mt-3" in={formVisible}>
            ...
            >
              <div style={{ marginTop: "20px" }}>
                ...
                <DialogContent>
                  <DebitForm formData={formData} setFormData={setFormData} setFormVisible={setFormVisible} setToggle={setToggle}/>
                </DialogContent>
              </div>
            </Card>
          </Collapse>
          <DebitTable debit={debit} setRecDelete={setRecDelete} setFormVisible={setFormVisible} toggle={toggle} setToggle={setToggle}/>
        </section>
      </div>
    </div>
  </div>
