...
import { deleteLoan } from './loanapi';
          ...
          .filter((elem)=>{
            if(search.length===0)
              ...
              <tr key={loan.id}>
                ...
                <td>
                      <span className={loan.status === "Active" ? "complete" : "incomplete"}>

                      {loan.status?loan.status:<p className="nil">--nil--</p>}
                    </span>
                      </td>
                <td className="mx-2">
                  <Link
                ...
                <td className="mx-2">
                    ...
                    <FaTrashAlt className='action-delete' onClick={() => deleteLoan(loan.grantLoanId)}
                    />
                </td>
              </tr>
            ))}
