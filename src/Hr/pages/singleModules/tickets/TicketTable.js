              ...
              : (rowsPerPage > 0
                  ...
                  .map((ticket, index) => (
                    <tr key={ticket.ticketsId}>
                      ...
                      <td>
                      <span className={ticket.status === "Active" ? "complete" : "inactive"}>

                      {ticket.status?ticket.status:<p className="nil">--nil--</p>}
                    </span>
                      </td>
                      <td className="mx-2">
                        <Link to={`/ticket-profile/${ticket.ticketsId}`}>
                      ...
                      <td className="mx-2">
                        <FaTrashAlt
                          ...
                          onClick={() => deleteTicket(ticket.ticketsId)}
                        />
                      </td>
                    </tr>
                  ))}
