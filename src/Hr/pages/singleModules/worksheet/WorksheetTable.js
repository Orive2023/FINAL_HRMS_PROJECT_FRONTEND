            ...
            if(search.length===0)
              ...
              elem.status?.toLowerCase().includes(search.toLowerCase())
                        ...
                        <tr key={worksheet.workSheetId}>
                          ...
                          <td>
                      <span className={worksheet.status === "Complete" ? "complete" : "incomplete"}>

                      {worksheet.status?worksheet.status:<p className="nil">--nil--</p>}
                    </span>
                    </td>
                          <td className="mx-2">
                          <Link
                            to={`/worksheet/worksheet-profile/${worksheet.workSheetId }`}
                          >
                        ...
                        <td className="mx-2">
                          <Link
                            to={`/worksheet/edit-worksheet/${worksheet.workSheetId }`}
                          >
                          ...
                          <td className="mx-2">
                              ...
                              <FaTrashAlt className='action-delete' onClick={() => deleteWorksheet(worksheet.workSheetId)}
                              />
                          </td>
                        </tr>
                      ))}
