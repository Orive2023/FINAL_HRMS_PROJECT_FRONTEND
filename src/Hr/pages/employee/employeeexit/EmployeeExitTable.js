  ...
  const convertToPdf = () => {
    try {
      ...
      doc.autoTable({
        ...
        body: employeeExit.map((row,index) => [
          index+1,
          row.employeeToExit,
          row.exitDate,
          row.typeOfExit,
          ...
          { employeeExit.length === 0 ? renderEmployeeExitData() : (rowsPerPage > 0
            ...
            if(search.length===0)
              ...
              <tr key={index}>
                ...
                <td className="mx-2">
                  <Link
                    to={`/employee/employee-exit-profile/${employeeExit.employeeExitId}`}
                  >
                ...
                <td className="mx-2">
                    ...
                    <FaTrashAlt   className='action-delete'  onClick={() =>
                      deleteEmployeeExit(employeeExit.employeeExitId)
                    }
/>
                </td>
              </tr>
