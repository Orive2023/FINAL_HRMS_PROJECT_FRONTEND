  ...
  const convertToPdf = () => {
    try {
      ...
      doc.autoTable({
        ...
        body: resignation.map((row, index) => [
          index + 1,
          row.employeeName,
          row.noticeDate,
          row.resignationDate,
              ...
              : (rowsPerPage > 0
                  ...
                  .map((resignation, index) => (
                    <tr key={index}>
                      ...
                      <td className="mx-2">
                        <Link
                          to={`/employee/resignation-profile/${resignation.resignationId}`}
                        >
                      ...
                      <td className="mx-2">
                        <FaTrashAlt
                          ...
                          onClick={() =>
                            deleteResignation(resignation.resignationId)
                          }
                        />
                      </td>
                    </tr>
