                  ...
                  .filter((elem) => {
                    if (search.length === 0) return elem;
                      ...
                      return (
                        ...
                        elem.createdDate.toString().includes(search) ||
                        elem.total.toString().includes(search)
                      );
                  })
                  .map((expense, index) => (
                    <tr key={expense.expenceId}>
                      ...
                      <td className="mx-2">
                        <Link
                          to={`/organisation/expences-profile/${expense.expenceId}`}
                        >
                      ...
                      <td className="mx-2">
                        <FaTrashAlt
                          ...
                          onClick={() => deleteExpenses(expense.expenceId)}
                        />
                      </td>
                    </tr>
                  ))}
