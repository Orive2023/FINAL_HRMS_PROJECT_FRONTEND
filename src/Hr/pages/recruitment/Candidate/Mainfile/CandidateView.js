    ...
    <div id="header-container" className="header-container">
      ...
      <div className="head-foot-part">
        <section>
          ...
          <Collapse   className="mt-3" in={formVisible}>
            ...
            >
               <div style={{ marginTop: "20px" }}>
                    <h3 className="form-header"> Candidate FORM</h3>
                  <DialogContent>
          ...
          <CandidateTable candidate={candidate} setRecDelete={setRecDelete} setFormVisible={setFormVisible} setToggle={setToggle} />
        </section>
      </div>
    </div>
  </div>
