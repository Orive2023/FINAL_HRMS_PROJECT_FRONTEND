  ...
  const convertToPdf = () => {
    try {
      ...
      doc.autoTable({
        ...
        body: product.map((row, index) => [
          index + 1,
          row.productPricePerUnit,
          row.noOfClients,
        ]),
    ...
    >
      ...
      <div className="table-start-container">
        <table id="table" className="table table-bordered table-hover shadow">
          ...
          {product.length === 0 ? renderproductsData() : (rowsPerPage > 0
          ...
          .filter((elem)=>{
            if(search.length===0)
              ...
              return (elem.productPricePerUnit.toString().toLowerCase().includes(search.toLocaleLowerCase()) ||
              elem.noOfClients.toString().toLowerCase().includes(search.toLocaleLowerCase()) 
                  ...
                  <tr key={index}>
                    ...
                    <td className="mx-2">
                    <Link to={`/sales/products-view/${product.revenueId}`}>
                      <FaEye className="action-eye" />
                    </Link>
                  </td> 
                     <td className="mx-2">
                    <Link to={`/sales/edit-products/${product.revenueId}`}>
                    ...
                    <td className="mx-3">
                      <FaTrashAlt
                        ...
                        onClick={() => deleteproducts(product.revenueId)}
                      />
                    </td>
                  </tr>
                ))}
