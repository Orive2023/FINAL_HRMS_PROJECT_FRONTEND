              ...
              : (rowsPerPage > 0
                  ...
                  .map((clients, index) => (
                    <tr key={clients.id}>
                      ...
                      <td>{clients.clientPosition}</td>
                      <td>{clients.status}</td>
                      <td className="mx-2">
                        <Link
                          to={`/clients/clients-profile/${clients.clientId}`}
                        >
                          <FaEye className="action-eye" />
                        </Link>
                      </td>
                      <td className="mx-2">
                        <Link to={`/clients/edit-clients/${clients.clientId}`}>
                      ...
                      <td className="mx-2">
                        <FaTrashAlt
                          ...
                          onClick={() => deleteClient(clients.clientId)}
                        />
                      </td>
                    </tr>
                  ))}
