  ...
  const convertToPdf = () => {
    try {
      ...
      doc.autoTable({
        ...
        body: advanceSalary.map((row, index) => [
          index + 1,
          row.employeeName,
          row.salary,
          row.advanceAmount,
              ...
              : (rowsPerPage > 0
                  ...
                  .filter((elem) => {
                    if (search.length === 0) return elem;
                      ...
                      return (
                        ...
                        elem.salary.toString().includes(search) ||
                        elem.advanceAmount.toString().includes(search) ||
                        elem.salaryDue
                          .toString()
                          .toLowerCase()
                          .includes(search) ||
                  ...
                  .map((advanceSalary, index) => (
                    <tr key={index}>
                      ...
                      <td className="mx-2">
                        <Link
                          to={`/hr/payroll/advance-profile/${advanceSalary.advanceSaleryId}`}
                        >
                      ...
                      <td className="mx-2">
                        <Link
                          to={`/payroll/edit-advance-salary/${advanceSalary.advanceSaleryId}`}
                        >
                      ...
                      <td className="mx-2">
                        <FaTrashAlt
                          className="action-delete"
                            onClick={() => deleteAdvanceSalary(advanceSalary.advanceSaleryId)}
                        />
                      </td>
                    </tr>
                  ))}
          ...
          <tfoot>
            <tr>
              <CustomTablePagination
                ...
                colSpan={12}
                count={Array.isArray(advanceSalary) ? advanceSalary.length : 0}
